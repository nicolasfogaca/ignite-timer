...
// nesse onChange, estou guardando oq o usuário digita dentro do input
// value={task}
// quando coloco o onSubmit direto na tag Form só vai guardar informação quando eu der o submit no formulário
